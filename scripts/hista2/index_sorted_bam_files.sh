...
#SBATCH --output=/data/users/vmungai/rna_seq_projects/rna-seq-blood-mice-toxoplasma-2025/logs/outputs/hista2/index_sorted_bam_files/output_index_sorted_bam_files_%A_%a.out
#SBATCH --error=/data/users/vmungai/rna_seq_projects/rna-seq-blood-mice-toxoplasma-2025/logs/errors/hista2/index_sorted_bam_files/error_index_sorted_bam_files_%A_%a.err
...
SORTED_BAM_FILES_LIST="$WORKDIR/results/hista2/index_sorted_bam_files/intermediate_results/sorted_bam_list.tsv"

# output directory for the sorted bam files 
OUTPUT_DIR="$WORKDIR/results/hista2/index_sorted_bam_files"
...
apptainer exec --bind /data/ /containers/apptainer/hisat2_samtools_408dfd02f175cd88.sif samtools index "$SORTED_BAM_FILE" -o "$INDEXED_S_BAM_FILE"