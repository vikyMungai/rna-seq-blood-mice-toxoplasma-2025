...
# my result directory 
OUTDIR="$WORKDIR/results/multiqc/"
...
FASTQC_LIST=`ls $WORKDIR/data/external_data/fastqc_output/*fastqc.zip`
...
apptainer exec --bind /data $CONTAINER multiqc -f -o "$OUTDIR" $FASTQC_LIST
